...
if (user === undefined) {    
    ...
    if (question1 === correctAnswers.question1) correctCount++;
    if (question2 === correctAnswers.question2) correctCount++;
    if (question3 === correctAnswers.question3) correctCount++;
    if (question4 === correctAnswers.question4) correctCount++;
